...
Lugar de almacenamiento: Dropbox.
 ...
 1. Repositorio APC_SIG (insumos) - los metadatos de las capas de este repositorio serán incorporados al catálogo digital de APC (GeoNetwork)
 2. Repositorio DESARROLLO_SIG - los metadatos de las capas verificadas de este repositorio serán incorporados al catálogo digital de APC (GeoNetwork)
 3. Repositorio PROYECTOS_SIG - los metadatos de las capas de este repositorio serán incorporados al catálogo digital de APC (GeoNetwork).


#### 1. Repositorio APC_SIG (Insumos)
...
La información clasificada como insumo (repositorio APC-SIG), se deberá guardar tal cual es proporcionada (conservando el nombre del archivo, metadatos, documentación y nombre de los campos). Si los datos tienen fecha se deberá poner al final del nombre del archivo.
...
Los usuarios deberán ocupar el siguiente formulario para reportar la entrega de la capa al responsable de los repositorios de SIG:
 https://goo.gl/forms/KbHd1EOHGBhypT6h2
